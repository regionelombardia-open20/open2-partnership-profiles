...
use open20\amos\partnershipprofiles\models\search\PartnershipProfilesCategorySearch;
 ...
 * PartnershipProfilesCategoryController implements the CRUD actions for PartnershipProfilesCategory model.
 *
 * @property \open20\amos\partnershipprofiles\models\PartnershipProfilesCategory $model
 * @property \open20\amos\partnershipprofiles\models\search\PartnershipProfilesCategorySearch $modelSearch
 *
 * @package open20\amos\partnershipprofiles\controllers\base
 */
class PartnershipProfilesCategoryController extends CrudController
{
    ...
    {
        $this->setModelObj(new PartnershipProfilesCategory());
        $this->setModelSearch(new PartnershipProfilesCategorySearch());
    ...
    /**
     * Lists all PartnershipProfilesCategory models.
     * @return mixed
     */
    ...
    /**
     * Displays a single PartnershipProfilesCategory model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new PartnershipProfilesCategory model.
    ...
    public function actionCreate()
    {
        ...
        $this->model = new PartnershipProfilesCategory();

        if ($this->model->load(Yii::$app->request->post()) && $this->model->validate()) {
            $this->model->color_text = $this->model->colorText();
            if ($this->model->save()) {
                $this->model->saveCategorieRolesMm();
    ...
    /**
     * Creates a new PartnershipProfilesCategory model by ajax request.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
...
//Yii::$app->getSession()->addFlash('danger', BaseAmosModule::t('amoscore', 'Item not created, check data'));
    ...
    /**
     * Updates an existing PartnershipProfilesCategory model.
    ...
    /**
     * Deletes an existing PartnershipProfilesCategory model.
